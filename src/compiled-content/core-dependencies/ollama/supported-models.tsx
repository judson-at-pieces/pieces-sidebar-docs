...
export interface MDX_core_dependencies_ollama_supported_modelsProps {
...
export default function MDX_core_dependencies_ollama_supported_models({ components = {} }: MDX_core_dependencies_ollama_supported_modelsProps) {
  const _components = {
