...
export interface MDX_core_dependencies_ollama_troubleshootingProps {
...
export default function MDX_core_dependencies_ollama_troubleshooting({ components = {} }: MDX_core_dependencies_ollama_troubleshootingProps) {
  const _components = {
...
MDX_core_dependencies_ollama_troubleshooting.displayName = 'MDX_core_dependencies_ollama_troubleshooting';
MDX_core_dependencies_ollama_troubleshooting.frontmatter = frontmatter;
