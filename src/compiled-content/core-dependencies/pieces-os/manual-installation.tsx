...
export interface MDX_core_dependencies_pieces_os_manual_installationProps {
...
export default function MDX_core_dependencies_pieces_os_manual_installation({ components = {} }: MDX_core_dependencies_pieces_os_manual_installationProps) {
  const _components = {
...
MDX_core_dependencies_pieces_os_manual_installation.displayName = 'MDX_core_dependencies_pieces_os_manual_installation';
MDX_core_dependencies_pieces_os_manual_installation.frontmatter = frontmatter;
