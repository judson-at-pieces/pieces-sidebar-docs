...
export interface MDX_core_dependencies_pieces_os_quick_menuProps {
...
export default function MDX_core_dependencies_pieces_os_quick_menu({ components = {} }: MDX_core_dependencies_pieces_os_quick_menuProps) {
  const _components = {
...
MDX_core_dependencies_pieces_os_quick_menu.displayName = 'MDX_core_dependencies_pieces_os_quick_menu';
MDX_core_dependencies_pieces_os_quick_menu.frontmatter = frontmatter;
