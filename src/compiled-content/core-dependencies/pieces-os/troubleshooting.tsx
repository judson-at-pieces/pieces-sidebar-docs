...
export interface MDX_core_dependencies_pieces_os_troubleshootingProps {
...
export default function MDX_core_dependencies_pieces_os_troubleshooting({ components = {} }: MDX_core_dependencies_pieces_os_troubleshootingProps) {
  const _components = {
...
MDX_core_dependencies_pieces_os_troubleshooting.displayName = 'MDX_core_dependencies_pieces_os_troubleshooting';
MDX_core_dependencies_pieces_os_troubleshooting.frontmatter = frontmatter;
