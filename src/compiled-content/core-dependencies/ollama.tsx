...
export interface MDX_core_dependencies_ollamaProps {
...
export default function MDX_core_dependencies_ollama({ components = {} }: MDX_core_dependencies_ollamaProps) {
  const _components = {
...
MDX_core_dependencies_ollama.displayName = 'MDX_core_dependencies_ollama';
MDX_core_dependencies_ollama.frontmatter = frontmatter;
