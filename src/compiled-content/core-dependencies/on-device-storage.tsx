...
export interface MDX_core_dependencies_on_device_storageProps {
...
export default function MDX_core_dependencies_on_device_storage({ components = {} }: MDX_core_dependencies_on_device_storageProps) {
  const _components = {
...
MDX_core_dependencies_on_device_storage.displayName = 'MDX_core_dependencies_on_device_storage';
MDX_core_dependencies_on_device_storage.frontmatter = frontmatter;
