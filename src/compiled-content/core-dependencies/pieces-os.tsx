...
export interface MDX_core_dependencies_pieces_osProps {
...
export default function MDX_core_dependencies_pieces_os({ components = {} }: MDX_core_dependencies_pieces_osProps) {
  const _components = {
...
MDX_core_dependencies_pieces_os.displayName = 'MDX_core_dependencies_pieces_os';
MDX_core_dependencies_pieces_os.frontmatter = frontmatter;
