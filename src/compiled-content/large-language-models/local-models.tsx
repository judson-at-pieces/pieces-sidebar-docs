...
export interface MDX_large_language_models_local_modelsProps {
...
export default function MDX_large_language_models_local_models({ components = {} }: MDX_large_language_models_local_modelsProps) {
  const _components = {
