...
export interface MDX_large_language_models_cloud_modelsProps {
...
export default function MDX_large_language_models_cloud_models({ components = {} }: MDX_large_language_models_cloud_modelsProps) {
  const _components = {
