...
export interface MDX_raycastProps {
...
export default function MDX_raycast({ components = {} }: MDX_raycastProps) {
  const _components = {
...
MDX_raycast.displayName = 'MDX_raycast';
MDX_raycast.frontmatter = frontmatter;
