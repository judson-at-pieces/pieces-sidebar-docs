...
export interface MDX_web_extensionProps {
...
export default function MDX_web_extension({ components = {} }: MDX_web_extensionProps) {
  const _components = {
...
MDX_web_extension.displayName = 'MDX_web_extension';
MDX_web_extension.frontmatter = frontmatter;
