...
export interface MDX_cli_troubleshootingProps {
...
function _createMdxContent(props: MDX_cli_troubleshootingProps) {
  const _components = {
    h2: "h2",
    p: "p",
    div: "div",
  ...
  return _jsxs("div", {
    children: [
      ...
      _jsx("p", {
        children: "Content for CLI troubleshooting documentation."
      })
    ]
  });
}

function MDXContent(props: MDX_cli_troubleshootingProps = {}) {
...
export default function MDX_cli_troubleshooting({ components = {} }: MDX_cli_troubleshootingProps) {
  const _components = {
...
MDX_cli_troubleshooting.displayName = 'MDX_cli_troubleshooting';
MDX_cli_troubleshooting.frontmatter = frontmatter;
