...
export interface MDX_cli_configurationProps {
...
export default function MDX_cli_configuration({ components = {} }: MDX_cli_configurationProps) {
  const _components = {
...
MDX_cli_configuration.displayName = 'MDX_cli_configuration';
MDX_cli_configuration.frontmatter = frontmatter;
