...
export interface MDX_cli_driveProps {
...
export default function MDX_cli_drive({ components = {} }: MDX_cli_driveProps) {
  const _components = {
...
MDX_cli_drive.displayName = 'MDX_cli_drive';
MDX_cli_drive.frontmatter = frontmatter;
