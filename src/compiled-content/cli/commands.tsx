...
export interface MDX_cli_commandsProps {
...
export default function MDX_cli_commands({ components = {} }: MDX_cli_commandsProps) {
  const _components = {
...
MDX_cli_commands.displayName = 'MDX_cli_commands';
MDX_cli_commands.frontmatter = frontmatter;
