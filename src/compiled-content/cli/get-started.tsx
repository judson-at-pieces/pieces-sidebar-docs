...
export interface MDX_cli_get_startedProps {
...
function _createMdxContent(props: MDX_cli_get_startedProps) {
  const _components = {
    h2: "h2",
    p: "p",
    div: "div",
  ...
  return _jsxs("div", {
    children: [
      ...
      _jsx("p", {
        children: "Content for CLI get started documentation."
      })
    ]
  });
}

function MDXContent(props: MDX_cli_get_startedProps = {}) {
...
export default function MDX_cli_get_started({ components = {} }: MDX_cli_get_startedProps) {
  const _components = {
...
MDX_cli_get_started.displayName = 'MDX_cli_get_started';
MDX_cli_get_started.frontmatter = frontmatter;
