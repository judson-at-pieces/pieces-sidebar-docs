...
export interface MDX_cli_copilotProps {
...
export default function MDX_cli_copilot({ components = {} }: MDX_cli_copilotProps) {
  const _components = {
...
MDX_cli_copilot.displayName = 'MDX_cli_copilot';
MDX_cli_copilot.frontmatter = frontmatter;
