...
export default function MDX_cli_copilot_chat({ components = {} }: MDX_cli_copilot_chatProps) {
  const _components = {
...
MDX_cli_copilot_chat.displayName = 'MDX_cli_copilot_chat';
MDX_cli_copilot_chat.frontmatter = frontmatter;
