...
export interface MDX_cli_copilot_llms_settingsProps {
...
export default function MDX_cli_copilot_llms_settings({ components = {} }: MDX_cli_copilot_llms_settingsProps) {
  const _components = {
...
MDX_cli_copilot_llms_settings.displayName = 'MDX_cli_copilot_llms_settings';
MDX_cli_copilot_llms_settings.frontmatter = frontmatter;
