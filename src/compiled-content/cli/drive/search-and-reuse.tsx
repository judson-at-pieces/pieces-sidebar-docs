...
export interface MDX_cli_drive_search_and_reuseProps {
  components?: Record<string, React.ComponentType<any>>;
}

export const frontmatter = {
  "title": "Search and Reuse Materials",
  "path": "/cli/drive/search-and-reuse",
  "visibility": "PUBLIC"
};

// MDX compiled content
function _createMdxContent(props: MDX_cli_drive_search_and_reuseProps) {
  const _components = {
    h2: "h2",
    p: "p",
    div: "div",
  ...
  return _jsxs("div", {
    children: [
      _jsx("h2", {
        children: "Search and Reuse Materials"
      }),
      _jsx("p", {
        children: "Content for CLI drive search and reuse documentation."
      })
    ]
  });
}

function MDXContent(props: MDX_cli_drive_search_and_reuseProps = {}) {
...
export default function MDX_cli_drive_search_and_reuse({ components = {} }: MDX_cli_drive_search_and_reuseProps) {
  const _components = {
...
MDX_cli_drive_search_and_reuse.displayName = 'MDX_cli_drive_search_and_reuse';
MDX_cli_drive_search_and_reuse.frontmatter = frontmatter;
