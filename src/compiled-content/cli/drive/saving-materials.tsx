...
export default function MDX_cli_drive_saving_materials({ components = {} }: MDX_cli_drive_saving_materialsProps) {
  const _components = {
...
MDX_cli_drive_saving_materials.displayName = 'MDX_cli_drive_saving_materials';
MDX_cli_drive_saving_materials.frontmatter = frontmatter;
