...
export interface MDX_cli_drive_sharingProps {
...
function _createMdxContent(props: MDX_cli_drive_sharingProps) {
  const _components = {
    h2: "h2",
    p: "p",
    div: "div",
  ...
  return _jsxs("div", {
    children: [
      ...
      _jsx("p", {
        children: "Content for CLI drive sharing documentation."
      })
    ]
  });
}

function MDXContent(props: MDX_cli_drive_sharingProps = {}) {
...
export default function MDX_cli_drive_sharing({ components = {} }: MDX_cli_drive_sharingProps) {
  const _components = {
...
MDX_cli_drive_sharing.displayName = 'MDX_cli_drive_sharing';
MDX_cli_drive_sharing.frontmatter = frontmatter;
