...
export interface MDX_obsidianProps {
...
export default function MDX_obsidian({ components = {} }: MDX_obsidianProps) {
  const _components = {
...
MDX_obsidian.displayName = 'MDX_obsidian';
MDX_obsidian.frontmatter = frontmatter;
