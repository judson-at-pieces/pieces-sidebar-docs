...
export interface MDX_large_language_modelsProps {
...
export default function MDX_large_language_models({ components = {} }: MDX_large_language_modelsProps) {
  const _components = {
...
MDX_large_language_models.displayName = 'MDX_large_language_models';
MDX_large_language_models.frontmatter = frontmatter;
