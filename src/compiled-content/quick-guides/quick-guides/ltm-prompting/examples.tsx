...
export interface MDX_quick_guides_quick_guides_ltm_prompting_examplesProps {
...
export default function MDX_quick_guides_quick_guides_ltm_prompting_examples({ components = {} }: MDX_quick_guides_quick_guides_ltm_prompting_examplesProps) {
  const _components = {
...
MDX_quick_guides_quick_guides_ltm_prompting_examples.displayName = 'MDX_quick_guides_quick_guides_ltm_prompting_examples';
MDX_quick_guides_quick_guides_ltm_prompting_examples.frontmatter = frontmatter;
