...
export interface MDX_quick_guides_quick_guides_ltm_prompting_tipsProps {
...
export default function MDX_quick_guides_quick_guides_ltm_prompting_tips({ components = {} }: MDX_quick_guides_quick_guides_ltm_prompting_tipsProps) {
  const _components = {
...
MDX_quick_guides_quick_guides_ltm_prompting_tips.displayName = 'MDX_quick_guides_quick_guides_ltm_prompting_tips';
MDX_quick_guides_quick_guides_ltm_prompting_tips.frontmatter = frontmatter;
