...
export interface MDX_quick_guides_quick_guides_ltm_prompting_workstream_activityProps {
...
export default function MDX_quick_guides_quick_guides_ltm_prompting_workstream_activity({ components = {} }: MDX_quick_guides_quick_guides_ltm_prompting_workstream_activityProps) {
  const _components = {
...
MDX_quick_guides_quick_guides_ltm_prompting_workstream_activity.displayName = 'MDX_quick_guides_quick_guides_ltm_prompting_workstream_activity';
MDX_quick_guides_quick_guides_ltm_prompting_workstream_activity.frontmatter = frontmatter;
