...
export interface MDX_quick_guides_quick_guides_copilot_with_contextProps {
...
export default function MDX_quick_guides_quick_guides_copilot_with_context({ components = {} }: MDX_quick_guides_quick_guides_copilot_with_contextProps) {
  const _components = {
...
MDX_quick_guides_quick_guides_copilot_with_context.displayName = 'MDX_quick_guides_quick_guides_copilot_with_context';
MDX_quick_guides_quick_guides_copilot_with_context.frontmatter = frontmatter;
