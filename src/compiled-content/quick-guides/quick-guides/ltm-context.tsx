...
export interface MDX_quick_guides_quick_guides_ltm_contextProps {
...
export default function MDX_quick_guides_quick_guides_ltm_context({ components = {} }: MDX_quick_guides_quick_guides_ltm_contextProps) {
  const _components = {
...
MDX_quick_guides_quick_guides_ltm_context.displayName = 'MDX_quick_guides_quick_guides_ltm_context';
MDX_quick_guides_quick_guides_ltm_context.frontmatter = frontmatter;
