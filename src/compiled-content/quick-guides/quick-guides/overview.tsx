...
export interface MDX_quick_guides_quick_guides_overviewProps {
...
export default function MDX_quick_guides_quick_guides_overview({ components = {} }: MDX_quick_guides_quick_guides_overviewProps) {
  const _components = {
...
MDX_quick_guides_quick_guides_overview.displayName = 'MDX_quick_guides_quick_guides_overview';
MDX_quick_guides_quick_guides_overview.frontmatter = frontmatter;
