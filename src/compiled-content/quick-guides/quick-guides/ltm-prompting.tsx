...
export interface MDX_quick_guides_quick_guides_ltm_promptingProps {
...
export default function MDX_quick_guides_quick_guides_ltm_prompting({ components = {} }: MDX_quick_guides_quick_guides_ltm_promptingProps) {
  const _components = {
...
MDX_quick_guides_quick_guides_ltm_prompting.displayName = 'MDX_quick_guides_quick_guides_ltm_prompting';
MDX_quick_guides_quick_guides_ltm_prompting.frontmatter = frontmatter;
