...
export interface MDX_desktop_troubleshootingProps {
...
export default function MDX_desktop_troubleshooting({ components = {} }: MDX_desktop_troubleshootingProps) {
  const _components = {
...
MDX_desktop_troubleshooting.displayName = 'MDX_desktop_troubleshooting';
MDX_desktop_troubleshooting.frontmatter = frontmatter;
