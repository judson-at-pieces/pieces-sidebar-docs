...
export interface MDX_desktop_actionsProps {
...
export default function MDX_desktop_actions({ components = {} }: MDX_desktop_actionsProps) {
  const _components = {
...
MDX_desktop_actions.displayName = 'MDX_desktop_actions';
MDX_desktop_actions.frontmatter = frontmatter;
