...
export interface MDX_desktop_drive_save_and_organizeProps {
...
export default function MDX_desktop_drive_save_and_organize({ components = {} }: MDX_desktop_drive_save_and_organizeProps) {
  const _components = {
...
MDX_desktop_drive_save_and_organize.displayName = 'MDX_desktop_drive_save_and_organize';
MDX_desktop_drive_save_and_organize.frontmatter = frontmatter;
