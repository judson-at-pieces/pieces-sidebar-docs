...
export interface MDX_desktop_drive_search_and_filterProps {
...
export default function MDX_desktop_drive_search_and_filter({ components = {} }: MDX_desktop_drive_search_and_filterProps) {
  const _components = {
...
MDX_desktop_drive_search_and_filter.displayName = 'MDX_desktop_drive_search_and_filter';
MDX_desktop_drive_search_and_filter.frontmatter = frontmatter;
