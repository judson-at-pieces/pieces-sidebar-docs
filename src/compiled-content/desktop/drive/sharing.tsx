...
export interface MDX_desktop_drive_sharingProps {
...
export default function MDX_desktop_drive_sharing({ components = {} }: MDX_desktop_drive_sharingProps) {
  const _components = {
...
MDX_desktop_drive_sharing.displayName = 'MDX_desktop_drive_sharing';
MDX_desktop_drive_sharing.frontmatter = frontmatter;
