...
export interface MDX_desktop_drive_transforming_codeProps {
...
export default function MDX_desktop_drive_transforming_code({ components = {} }: MDX_desktop_drive_transforming_codeProps) {
  const _components = {
...
MDX_desktop_drive_transforming_code.displayName = 'MDX_desktop_drive_transforming_code';
MDX_desktop_drive_transforming_code.frontmatter = frontmatter;
