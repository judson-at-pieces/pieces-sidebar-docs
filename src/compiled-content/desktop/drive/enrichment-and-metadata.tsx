...
export interface MDX_desktop_drive_enrichment_and_metadataProps {
...
export default function MDX_desktop_drive_enrichment_and_metadata({ components = {} }: MDX_desktop_drive_enrichment_and_metadataProps) {
  const _components = {
...
MDX_desktop_drive_enrichment_and_metadata.displayName = 'MDX_desktop_drive_enrichment_and_metadata';
MDX_desktop_drive_enrichment_and_metadata.frontmatter = frontmatter;
