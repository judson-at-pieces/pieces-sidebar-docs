...
export interface MDX_desktop_downloadProps {
...
export default function MDX_desktop_download({ components = {} }: MDX_desktop_downloadProps) {
  const _components = {
...
MDX_desktop_download.displayName = 'MDX_desktop_download';
MDX_desktop_download.frontmatter = frontmatter;
