...
export interface MDX_desktop_actions_power_menuProps {
...
export default function MDX_desktop_actions_power_menu({ components = {} }: MDX_desktop_actions_power_menuProps) {
  const _components = {
...
MDX_desktop_actions_power_menu.displayName = 'MDX_desktop_actions_power_menu';
MDX_desktop_actions_power_menu.frontmatter = frontmatter;
