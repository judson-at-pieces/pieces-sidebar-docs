...
export interface MDX_desktop_actions_keyboard_shortcutsProps {
...
export default function MDX_desktop_actions_keyboard_shortcuts({ components = {} }: MDX_desktop_actions_keyboard_shortcutsProps) {
  const _components = {
...
MDX_desktop_actions_keyboard_shortcuts.displayName = 'MDX_desktop_actions_keyboard_shortcuts';
MDX_desktop_actions_keyboard_shortcuts.frontmatter = frontmatter;
