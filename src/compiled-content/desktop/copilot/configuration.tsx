...
export interface MDX_desktop_copilot_configurationProps {
...
export default function MDX_desktop_copilot_configuration({ components = {} }: MDX_desktop_copilot_configurationProps) {
  const _components = {
...
MDX_desktop_copilot_configuration.displayName = 'MDX_desktop_copilot_configuration';
MDX_desktop_copilot_configuration.frontmatter = frontmatter;
