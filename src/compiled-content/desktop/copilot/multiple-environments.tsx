...
export interface MDX_desktop_copilot_multiple_environmentsProps {
...
export default function MDX_desktop_copilot_multiple_environments({ components = {} }: MDX_desktop_copilot_multiple_environmentsProps) {
  const _components = {
...
MDX_desktop_copilot_multiple_environments.displayName = 'MDX_desktop_copilot_multiple_environments';
MDX_desktop_copilot_multiple_environments.frontmatter = frontmatter;
