...
export interface MDX_desktop_copilot_integrationProps {
...
export default function MDX_desktop_copilot_integration({ components = {} }: MDX_desktop_copilot_integrationProps) {
  const _components = {
...
MDX_desktop_copilot_integration.displayName = 'MDX_desktop_copilot_integration';
MDX_desktop_copilot_integration.frontmatter = frontmatter;
