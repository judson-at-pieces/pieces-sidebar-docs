...
export interface MDX_desktop_copilot_interactionProps {
...
export default function MDX_desktop_copilot_interaction({ components = {} }: MDX_desktop_copilot_interactionProps) {
  const _components = {
...
MDX_desktop_copilot_interaction.displayName = 'MDX_desktop_copilot_interaction';
MDX_desktop_copilot_interaction.frontmatter = frontmatter;
