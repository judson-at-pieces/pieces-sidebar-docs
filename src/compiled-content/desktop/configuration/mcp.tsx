...
export interface MDX_desktop_configuration_mcpProps {
...
export default function MDX_desktop_configuration_mcp({ components = {} }: MDX_desktop_configuration_mcpProps) {
  const _components = {
...
MDX_desktop_configuration_mcp.displayName = 'MDX_desktop_configuration_mcp';
MDX_desktop_configuration_mcp.frontmatter = frontmatter;
