...
export interface MDX_desktop_configuration_additional_settingsProps {
...
export default function MDX_desktop_configuration_additional_settings({ components = {} }: MDX_desktop_configuration_additional_settingsProps) {
  const _components = {
...
MDX_desktop_configuration_additional_settings.displayName = 'MDX_desktop_configuration_additional_settings';
MDX_desktop_configuration_additional_settings.frontmatter = frontmatter;
