...
export interface MDX_desktop_configuration_account_and_cloudProps {
...
export default function MDX_desktop_configuration_account_and_cloud({ components = {} }: MDX_desktop_configuration_account_and_cloudProps) {
  const _components = {
...
MDX_desktop_configuration_account_and_cloud.displayName = 'MDX_desktop_configuration_account_and_cloud';
MDX_desktop_configuration_account_and_cloud.frontmatter = frontmatter;
