...
export interface MDX_desktop_configuration_copilot_and_machine_learningProps {
...
export default function MDX_desktop_configuration_copilot_and_machine_learning({ components = {} }: MDX_desktop_configuration_copilot_and_machine_learningProps) {
  const _components = {
...
MDX_desktop_configuration_copilot_and_machine_learning.displayName = 'MDX_desktop_configuration_copilot_and_machine_learning';
MDX_desktop_configuration_copilot_and_machine_learning.frontmatter = frontmatter;
