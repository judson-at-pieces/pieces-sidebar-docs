...
export interface MDX_desktop_configuration_supportProps {
...
export default function MDX_desktop_configuration_support({ components = {} }: MDX_desktop_configuration_supportProps) {
  const _components = {
...
MDX_desktop_configuration_support.displayName = 'MDX_desktop_configuration_support';
MDX_desktop_configuration_support.frontmatter = frontmatter;
