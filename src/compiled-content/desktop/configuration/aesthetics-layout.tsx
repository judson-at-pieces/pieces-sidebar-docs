...
export interface MDX_desktop_configuration_aesthetics_layoutProps {
...
export default function MDX_desktop_configuration_aesthetics_layout({ components = {} }: MDX_desktop_configuration_aesthetics_layoutProps) {
  const _components = {
...
MDX_desktop_configuration_aesthetics_layout.displayName = 'MDX_desktop_configuration_aesthetics_layout';
MDX_desktop_configuration_aesthetics_layout.frontmatter = frontmatter;
