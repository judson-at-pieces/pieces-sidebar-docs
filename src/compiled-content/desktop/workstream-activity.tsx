...
export interface MDX_desktop_workstream_activityProps {
...
export default function MDX_desktop_workstream_activity({ components = {} }: MDX_desktop_workstream_activityProps) {
  const _components = {
...
MDX_desktop_workstream_activity.displayName = 'MDX_desktop_workstream_activity';
MDX_desktop_workstream_activity.frontmatter = frontmatter;
