...
export interface MDX_desktop_configurationProps {
...
export default function MDX_desktop_configuration({ components = {} }: MDX_desktop_configurationProps) {
  const _components = {
...
MDX_desktop_configuration.displayName = 'MDX_desktop_configuration';
MDX_desktop_configuration.frontmatter = frontmatter;
