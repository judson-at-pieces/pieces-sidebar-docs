...
export interface MDX_desktop_copilotProps {
...
export default function MDX_desktop_copilot({ components = {} }: MDX_desktop_copilotProps) {
  const _components = {
...
MDX_desktop_copilot.displayName = 'MDX_desktop_copilot';
MDX_desktop_copilot.frontmatter = frontmatter;
