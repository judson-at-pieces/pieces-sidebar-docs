...
export interface MDX_desktop_driveProps {
...
export default function MDX_desktop_drive({ components = {} }: MDX_desktop_driveProps) {
  const _components = {
...
MDX_desktop_drive.displayName = 'MDX_desktop_drive';
MDX_desktop_drive.frontmatter = frontmatter;
