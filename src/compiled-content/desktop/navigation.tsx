...
export interface MDX_desktop_navigationProps {
...
export default function MDX_desktop_navigation({ components = {} }: MDX_desktop_navigationProps) {
  const _components = {
...
MDX_desktop_navigation.displayName = 'MDX_desktop_navigation';
MDX_desktop_navigation.frontmatter = frontmatter;
