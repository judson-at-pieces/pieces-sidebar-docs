...
export interface MDX_desktop_troubleshooting_linuxProps {
...
export default function MDX_desktop_troubleshooting_linux({ components = {} }: MDX_desktop_troubleshooting_linuxProps) {
  const _components = {
...
MDX_desktop_troubleshooting_linux.displayName = 'MDX_desktop_troubleshooting_linux';
MDX_desktop_troubleshooting_linux.frontmatter = frontmatter;
