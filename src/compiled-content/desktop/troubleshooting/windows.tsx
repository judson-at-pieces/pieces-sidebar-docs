...
export interface MDX_desktop_troubleshooting_windowsProps {
...
export default function MDX_desktop_troubleshooting_windows({ components = {} }: MDX_desktop_troubleshooting_windowsProps) {
  const _components = {
...
MDX_desktop_troubleshooting_windows.displayName = 'MDX_desktop_troubleshooting_windows';
MDX_desktop_troubleshooting_windows.frontmatter = frontmatter;
