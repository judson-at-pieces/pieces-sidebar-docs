...
export interface MDX_desktop_troubleshooting_cross_platformProps {
...
export default function MDX_desktop_troubleshooting_cross_platform({ components = {} }: MDX_desktop_troubleshooting_cross_platformProps) {
  const _components = {
...
MDX_desktop_troubleshooting_cross_platform.displayName = 'MDX_desktop_troubleshooting_cross_platform';
MDX_desktop_troubleshooting_cross_platform.frontmatter = frontmatter;
