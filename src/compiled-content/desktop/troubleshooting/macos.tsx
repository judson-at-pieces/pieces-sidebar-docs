...
export interface MDX_desktop_troubleshooting_macosProps {
...
export default function MDX_desktop_troubleshooting_macos({ components = {} }: MDX_desktop_troubleshooting_macosProps) {
  const _components = {
...
MDX_desktop_troubleshooting_macos.displayName = 'MDX_desktop_troubleshooting_macos';
MDX_desktop_troubleshooting_macos.frontmatter = frontmatter;
