...
export interface MDX_desktop_navigation_snippet_discoveryProps {
...
export default function MDX_desktop_navigation_snippet_discovery({ components = {} }: MDX_desktop_navigation_snippet_discoveryProps) {
  const _components = {
...
MDX_desktop_navigation_snippet_discovery.displayName = 'MDX_desktop_navigation_snippet_discovery';
MDX_desktop_navigation_snippet_discovery.frontmatter = frontmatter;
