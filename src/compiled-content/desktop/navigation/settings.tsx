...
export interface MDX_desktop_navigation_settingsProps {
...
export default function MDX_desktop_navigation_settings({ components = {} }: MDX_desktop_navigation_settingsProps) {
  const _components = {
...
MDX_desktop_navigation_settings.displayName = 'MDX_desktop_navigation_settings';
MDX_desktop_navigation_settings.frontmatter = frontmatter;
