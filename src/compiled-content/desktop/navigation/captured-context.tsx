...
export interface MDX_desktop_navigation_captured_contextProps {
...
export default function MDX_desktop_navigation_captured_context({ components = {} }: MDX_desktop_navigation_captured_contextProps) {
  const _components = {
...
MDX_desktop_navigation_captured_context.displayName = 'MDX_desktop_navigation_captured_context';
MDX_desktop_navigation_captured_context.frontmatter = frontmatter;
