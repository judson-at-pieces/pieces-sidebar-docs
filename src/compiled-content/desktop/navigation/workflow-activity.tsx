...
export interface MDX_desktop_navigation_workflow_activityProps {
...
export default function MDX_desktop_navigation_workflow_activity({ components = {} }: MDX_desktop_navigation_workflow_activityProps) {
  const _components = {
...
MDX_desktop_navigation_workflow_activity.displayName = 'MDX_desktop_navigation_workflow_activity';
MDX_desktop_navigation_workflow_activity.frontmatter = frontmatter;
