...
export interface MDX_desktop_navigation_updatesProps {
...
export default function MDX_desktop_navigation_updates({ components = {} }: MDX_desktop_navigation_updatesProps) {
  const _components = {
...
MDX_desktop_navigation_updates.displayName = 'MDX_desktop_navigation_updates';
MDX_desktop_navigation_updates.frontmatter = frontmatter;
