...
export interface MDX_desktop_navigation_global_searchProps {
...
export default function MDX_desktop_navigation_global_search({ components = {} }: MDX_desktop_navigation_global_searchProps) {
  const _components = {
...
MDX_desktop_navigation_global_search.displayName = 'MDX_desktop_navigation_global_search';
MDX_desktop_navigation_global_search.frontmatter = frontmatter;
