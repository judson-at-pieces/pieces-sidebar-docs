...
export interface MDX_desktop_onboardingProps {
...
export default function MDX_desktop_onboarding({ components = {} }: MDX_desktop_onboardingProps) {
  const _components = {
...
MDX_desktop_onboarding.displayName = 'MDX_desktop_onboarding';
MDX_desktop_onboarding.frontmatter = frontmatter;
