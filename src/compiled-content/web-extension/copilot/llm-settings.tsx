...
export interface MDX_web_extension_copilot_llm_settingsProps {
...
export default function MDX_web_extension_copilot_llm_settings({ components = {} }: MDX_web_extension_copilot_llm_settingsProps) {
  const _components = {
...
MDX_web_extension_copilot_llm_settings.displayName = 'MDX_web_extension_copilot_llm_settings';
MDX_web_extension_copilot_llm_settings.frontmatter = frontmatter;
