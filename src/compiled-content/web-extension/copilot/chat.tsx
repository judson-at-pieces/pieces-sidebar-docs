...
export interface MDX_web_extension_copilot_chatProps {
...
export default function MDX_web_extension_copilot_chat({ components = {} }: MDX_web_extension_copilot_chatProps) {
  const _components = {
...
MDX_web_extension_copilot_chat.displayName = 'MDX_web_extension_copilot_chat';
MDX_web_extension_copilot_chat.frontmatter = frontmatter;
