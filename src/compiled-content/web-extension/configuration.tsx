...
export interface MDX_web_extension_configurationProps {
...
export default function MDX_web_extension_configuration({ components = {} }: MDX_web_extension_configurationProps) {
  const _components = {
...
MDX_web_extension_configuration.displayName = 'MDX_web_extension_configuration';
MDX_web_extension_configuration.frontmatter = frontmatter;
