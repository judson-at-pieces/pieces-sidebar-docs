...
export interface MDX_web_extension_troubleshootingProps {
...
export default function MDX_web_extension_troubleshooting({ components = {} }: MDX_web_extension_troubleshootingProps) {
  const _components = {
...
MDX_web_extension_troubleshooting.displayName = 'MDX_web_extension_troubleshooting';
MDX_web_extension_troubleshooting.frontmatter = frontmatter;
