...
export interface MDX_web_extension_drive_sharingProps {
...
export default function MDX_web_extension_drive_sharing({ components = {} }: MDX_web_extension_drive_sharingProps) {
  const _components = {
...
MDX_web_extension_drive_sharing.displayName = 'MDX_web_extension_drive_sharing';
MDX_web_extension_drive_sharing.frontmatter = frontmatter;
