...
export interface MDX_web_extension_drive_edit_updateProps {
...
export default function MDX_web_extension_drive_edit_update({ components = {} }: MDX_web_extension_drive_edit_updateProps) {
  const _components = {
...
MDX_web_extension_drive_edit_update.displayName = 'MDX_web_extension_drive_edit_update';
MDX_web_extension_drive_edit_update.frontmatter = frontmatter;
