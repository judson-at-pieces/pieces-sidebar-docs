...
export interface MDX_web_extension_drive_save_snippetsProps {
...
export default function MDX_web_extension_drive_save_snippets({ components = {} }: MDX_web_extension_drive_save_snippetsProps) {
  const _components = {
...
MDX_web_extension_drive_save_snippets.displayName = 'MDX_web_extension_drive_save_snippets';
MDX_web_extension_drive_save_snippets.frontmatter = frontmatter;
