...
export interface MDX_web_extension_drive_search_reuseProps {
...
export default function MDX_web_extension_drive_search_reuse({ components = {} }: MDX_web_extension_drive_search_reuseProps) {
  const _components = {
...
MDX_web_extension_drive_search_reuse.displayName = 'MDX_web_extension_drive_search_reuse';
MDX_web_extension_drive_search_reuse.frontmatter = frontmatter;
