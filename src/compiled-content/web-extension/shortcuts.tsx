...
export interface MDX_web_extension_shortcutsProps {
...
export default function MDX_web_extension_shortcuts({ components = {} }: MDX_web_extension_shortcutsProps) {
  const _components = {
...
MDX_web_extension_shortcuts.displayName = 'MDX_web_extension_shortcuts';
MDX_web_extension_shortcuts.frontmatter = frontmatter;
