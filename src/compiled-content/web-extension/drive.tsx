...
export interface MDX_web_extension_driveProps {
...
export default function MDX_web_extension_drive({ components = {} }: MDX_web_extension_driveProps) {
  const _components = {
...
MDX_web_extension_drive.displayName = 'MDX_web_extension_drive';
MDX_web_extension_drive.frontmatter = frontmatter;
