...
export interface MDX_web_extension_copilotProps {
...
export default function MDX_web_extension_copilot({ components = {} }: MDX_web_extension_copilotProps) {
  const _components = {
...
MDX_web_extension_copilot.displayName = 'MDX_web_extension_copilot';
MDX_web_extension_copilot.frontmatter = frontmatter;
