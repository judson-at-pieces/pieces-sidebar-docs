...
export interface MDX_web_extension_get_startedProps {
...
export default function MDX_web_extension_get_started({ components = {} }: MDX_web_extension_get_startedProps) {
  const _components = {
...
MDX_web_extension_get_started.displayName = 'MDX_web_extension_get_started';
MDX_web_extension_get_started.frontmatter = frontmatter;
