...
export interface MDX_privacy_security_your_dataProps {
...
export default function MDX_privacy_security_your_data({ components = {} }: MDX_privacy_security_your_dataProps) {
  const _components = {
...
MDX_privacy_security_your_data.displayName = 'MDX_privacy_security_your_data';
MDX_privacy_security_your_data.frontmatter = frontmatter;
