...
export interface MDX_meet_piecesProps {
...
export default function MDX_meet_pieces({ components = {} }: MDX_meet_piecesProps) {
  const _components = {
...
MDX_meet_pieces.displayName = 'MDX_meet_pieces';
MDX_meet_pieces.frontmatter = frontmatter;
