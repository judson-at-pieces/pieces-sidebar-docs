...
export interface MDX_meet_pieces_troubleshooting_cross_platformProps {
...
export default function MDX_meet_pieces_troubleshooting_cross_platform({ components = {} }: MDX_meet_pieces_troubleshooting_cross_platformProps) {
  const _components = {
...
MDX_meet_pieces_troubleshooting_cross_platform.displayName = 'MDX_meet_pieces_troubleshooting_cross_platform';
MDX_meet_pieces_troubleshooting_cross_platform.frontmatter = frontmatter;
