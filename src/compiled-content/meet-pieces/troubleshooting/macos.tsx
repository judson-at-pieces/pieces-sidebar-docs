...
export interface MDX_meet_pieces_troubleshooting_macosProps {
...
export default function MDX_meet_pieces_troubleshooting_macos({ components = {} }: MDX_meet_pieces_troubleshooting_macosProps) {
  const _components = {
...
MDX_meet_pieces_troubleshooting_macos.displayName = 'MDX_meet_pieces_troubleshooting_macos';
MDX_meet_pieces_troubleshooting_macos.frontmatter = frontmatter;
