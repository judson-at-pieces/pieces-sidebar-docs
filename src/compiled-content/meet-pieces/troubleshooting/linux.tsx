...
export interface MDX_meet_pieces_troubleshooting_linuxProps {
...
export default function MDX_meet_pieces_troubleshooting_linux({ components = {} }: MDX_meet_pieces_troubleshooting_linuxProps) {
  const _components = {
...
MDX_meet_pieces_troubleshooting_linux.displayName = 'MDX_meet_pieces_troubleshooting_linux';
MDX_meet_pieces_troubleshooting_linux.frontmatter = frontmatter;
