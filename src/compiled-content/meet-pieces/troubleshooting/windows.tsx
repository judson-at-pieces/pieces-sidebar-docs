...
export interface MDX_meet_pieces_troubleshooting_windowsProps {
...
export default function MDX_meet_pieces_troubleshooting_windows({ components = {} }: MDX_meet_pieces_troubleshooting_windowsProps) {
  const _components = {
...
MDX_meet_pieces_troubleshooting_windows.displayName = 'MDX_meet_pieces_troubleshooting_windows';
MDX_meet_pieces_troubleshooting_windows.frontmatter = frontmatter;
