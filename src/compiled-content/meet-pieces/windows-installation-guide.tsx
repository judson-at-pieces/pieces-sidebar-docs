...
export interface MDX_meet_pieces_windows_installation_guideProps {
...
export default function MDX_meet_pieces_windows_installation_guide({ components = {} }: MDX_meet_pieces_windows_installation_guideProps) {
  const _components = {
...
MDX_meet_pieces_windows_installation_guide.displayName = 'MDX_meet_pieces_windows_installation_guide';
MDX_meet_pieces_windows_installation_guide.frontmatter = frontmatter;
