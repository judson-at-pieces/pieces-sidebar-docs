...
export interface MDX_meet_pieces_troubleshootingProps {
...
export default function MDX_meet_pieces_troubleshooting({ components = {} }: MDX_meet_pieces_troubleshootingProps) {
  const _components = {
...
MDX_meet_pieces_troubleshooting.displayName = 'MDX_meet_pieces_troubleshooting';
MDX_meet_pieces_troubleshooting.frontmatter = frontmatter;
