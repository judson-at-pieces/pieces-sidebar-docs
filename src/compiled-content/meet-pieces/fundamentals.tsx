...
export interface MDX_meet_pieces_fundamentalsProps {
...
export default function MDX_meet_pieces_fundamentals({ components = {} }: MDX_meet_pieces_fundamentalsProps) {
  const _components = {
...
MDX_meet_pieces_fundamentals.displayName = 'MDX_meet_pieces_fundamentals';
MDX_meet_pieces_fundamentals.frontmatter = frontmatter;
