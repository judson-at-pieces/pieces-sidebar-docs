...
export interface MDX_desktopProps {
...
export default function MDX_desktop({ components = {} }: MDX_desktopProps) {
  const _components = {
...
MDX_desktop.displayName = 'MDX_desktop';
MDX_desktop.frontmatter = frontmatter;
