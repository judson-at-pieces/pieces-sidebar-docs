...
export interface MDX_supportProps {
...
export default function MDX_support({ components = {} }: MDX_supportProps) {
  const _components = {
...
MDX_support.displayName = 'MDX_support';
MDX_support.frontmatter = frontmatter;
