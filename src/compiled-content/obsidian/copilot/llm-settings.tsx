...
export interface MDX_obsidian_copilot_llm_settingsProps {
...
export default function MDX_obsidian_copilot_llm_settings({ components = {} }: MDX_obsidian_copilot_llm_settingsProps) {
  const _components = {
...
MDX_obsidian_copilot_llm_settings.displayName = 'MDX_obsidian_copilot_llm_settings';
MDX_obsidian_copilot_llm_settings.frontmatter = frontmatter;
