...
export interface MDX_obsidian_copilotProps {
...
export default function MDX_obsidian_copilot({ components = {} }: MDX_obsidian_copilotProps) {
  const _components = {
...
MDX_obsidian_copilot.displayName = 'MDX_obsidian_copilot';
MDX_obsidian_copilot.frontmatter = frontmatter;
