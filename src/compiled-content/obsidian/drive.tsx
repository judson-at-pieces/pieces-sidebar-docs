...
export interface MDX_obsidian_driveProps {
...
export default function MDX_obsidian_drive({ components = {} }: MDX_obsidian_driveProps) {
  const _components = {
...
MDX_obsidian_drive.displayName = 'MDX_obsidian_drive';
MDX_obsidian_drive.frontmatter = frontmatter;
