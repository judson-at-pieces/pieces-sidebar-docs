...
export interface MDX_obsidian_drive_search_reuseProps {
...
export default function MDX_obsidian_drive_search_reuse({ components = {} }: MDX_obsidian_drive_search_reuseProps) {
  const _components = {
...
MDX_obsidian_drive_search_reuse.displayName = 'MDX_obsidian_drive_search_reuse';
MDX_obsidian_drive_search_reuse.frontmatter = frontmatter;
