...
export interface MDX_obsidian_drive_edit_updateProps {
...
export default function MDX_obsidian_drive_edit_update({ components = {} }: MDX_obsidian_drive_edit_updateProps) {
  const _components = {
...
MDX_obsidian_drive_edit_update.displayName = 'MDX_obsidian_drive_edit_update';
MDX_obsidian_drive_edit_update.frontmatter = frontmatter;
