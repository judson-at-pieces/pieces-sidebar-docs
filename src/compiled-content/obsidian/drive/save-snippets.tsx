...
export interface MDX_obsidian_drive_save_snippetsProps {
...
export default function MDX_obsidian_drive_save_snippets({ components = {} }: MDX_obsidian_drive_save_snippetsProps) {
  const _components = {
...
MDX_obsidian_drive_save_snippets.displayName = 'MDX_obsidian_drive_save_snippets';
MDX_obsidian_drive_save_snippets.frontmatter = frontmatter;
