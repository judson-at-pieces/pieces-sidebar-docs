...
export interface MDX_obsidian_drive_sharingProps {
...
export default function MDX_obsidian_drive_sharing({ components = {} }: MDX_obsidian_drive_sharingProps) {
  const _components = {
...
MDX_obsidian_drive_sharing.displayName = 'MDX_obsidian_drive_sharing';
MDX_obsidian_drive_sharing.frontmatter = frontmatter;
