...
export interface MDX_obsidian_commandsProps {
...
export default function MDX_obsidian_commands({ components = {} }: MDX_obsidian_commandsProps) {
  const _components = {
...
MDX_obsidian_commands.displayName = 'MDX_obsidian_commands';
MDX_obsidian_commands.frontmatter = frontmatter;
