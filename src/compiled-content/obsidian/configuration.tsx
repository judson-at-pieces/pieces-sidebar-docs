...
export interface MDX_obsidian_configurationProps {
...
export default function MDX_obsidian_configuration({ components = {} }: MDX_obsidian_configurationProps) {
  const _components = {
...
MDX_obsidian_configuration.displayName = 'MDX_obsidian_configuration';
MDX_obsidian_configuration.frontmatter = frontmatter;
