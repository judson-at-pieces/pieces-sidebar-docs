...
export interface MDX_obsidian_get_startedProps {
...
export default function MDX_obsidian_get_started({ components = {} }: MDX_obsidian_get_startedProps) {
  const _components = {
...
MDX_obsidian_get_started.displayName = 'MDX_obsidian_get_started';
MDX_obsidian_get_started.frontmatter = frontmatter;
