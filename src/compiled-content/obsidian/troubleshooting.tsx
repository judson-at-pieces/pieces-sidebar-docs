...
export interface MDX_obsidian_troubleshootingProps {
...
export default function MDX_obsidian_troubleshooting({ components = {} }: MDX_obsidian_troubleshootingProps) {
  const _components = {
...
MDX_obsidian_troubleshooting.displayName = 'MDX_obsidian_troubleshooting';
MDX_obsidian_troubleshooting.frontmatter = frontmatter;
