...
export interface MDX_extensions_plugins_extensions_plugins_untitled_pageasd_troubleshootingProps {
...
export default function MDX_extensions_plugins_extensions_plugins_untitled_pageasd_troubleshooting({ components = {} }: MDX_extensions_plugins_extensions_plugins_untitled_pageasd_troubleshootingProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_untitled_pageasd_troubleshooting.displayName = 'MDX_extensions_plugins_extensions_plugins_untitled_pageasd_troubleshooting';
MDX_extensions_plugins_extensions_plugins_untitled_pageasd_troubleshooting.frontmatter = frontmatter;
