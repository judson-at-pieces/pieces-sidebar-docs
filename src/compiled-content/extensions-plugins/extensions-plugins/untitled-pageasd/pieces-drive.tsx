...
export interface MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_driveProps {
...
export default function MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive({ components = {} }: MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_driveProps) {
  const _components = {
