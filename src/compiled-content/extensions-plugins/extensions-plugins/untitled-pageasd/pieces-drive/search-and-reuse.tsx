...
export interface MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_search_and_reuseProps {
...
export default function MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_search_and_reuse({ components = {} }: MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_search_and_reuseProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_search_and_reuse.displayName = 'MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_search_and_reuse';
MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_search_and_reuse.frontmatter = frontmatter;
