...
export interface MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_edit_and_updateProps {
...
export default function MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_edit_and_update({ components = {} }: MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_edit_and_updateProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_edit_and_update.displayName = 'MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_edit_and_update';
MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_drive_edit_and_update.frontmatter = frontmatter;
