...
export interface MDX_extensions_plugins_extensions_plugins_untitled_pageasd_commandsProps {
...
export default function MDX_extensions_plugins_extensions_plugins_untitled_pageasd_commands({ components = {} }: MDX_extensions_plugins_extensions_plugins_untitled_pageasd_commandsProps) {
  const _components = {
