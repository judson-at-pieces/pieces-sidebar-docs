...
export interface MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_copilotProps {
...
export default function MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_copilot({ components = {} }: MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_copilotProps) {
  const _components = {
