...
export interface MDX_extensions_plugins_extensions_plugins_untitled_pageasd_configurationProps {
...
export default function MDX_extensions_plugins_extensions_plugins_untitled_pageasd_configuration({ components = {} }: MDX_extensions_plugins_extensions_plugins_untitled_pageasd_configurationProps) {
  const _components = {
