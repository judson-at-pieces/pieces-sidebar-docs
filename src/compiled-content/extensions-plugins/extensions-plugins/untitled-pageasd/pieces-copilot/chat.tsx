...
export interface MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_copilot_chatProps {
...
export default function MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_copilot_chat({ components = {} }: MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_copilot_chatProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_copilot_chat.displayName = 'MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_copilot_chat';
MDX_extensions_plugins_extensions_plugins_untitled_pageasd_pieces_copilot_chat.frontmatter = frontmatter;
