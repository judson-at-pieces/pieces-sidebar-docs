...
export interface MDX_extensions_plugins_extensions_plugins_untitled_pageasd_getProps {
...
export default function MDX_extensions_plugins_extensions_plugins_untitled_pageasd_get({ components = {} }: MDX_extensions_plugins_extensions_plugins_untitled_pageasd_getProps) {
  const _components = {
