...
export interface MDX_extensions_plugins_extensions_plugins_neovim_pluginProps {
...
export default function MDX_extensions_plugins_extensions_plugins_neovim_plugin({ components = {} }: MDX_extensions_plugins_extensions_plugins_neovim_pluginProps) {
  const _components = {
