...
export interface MDX_extensions_plugins_extensions_plugins_jetbrainsProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jetbrains({ components = {} }: MDX_extensions_plugins_extensions_plugins_jetbrainsProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jetbrains.displayName = 'MDX_extensions_plugins_extensions_plugins_jetbrains';
MDX_extensions_plugins_extensions_plugins_jetbrains.frontmatter = frontmatter;
