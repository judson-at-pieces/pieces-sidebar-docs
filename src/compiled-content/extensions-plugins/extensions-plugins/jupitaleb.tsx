...
export interface MDX_extensions_plugins_extensions_plugins_jupitalebProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitalebProps) {
  const _components = {
