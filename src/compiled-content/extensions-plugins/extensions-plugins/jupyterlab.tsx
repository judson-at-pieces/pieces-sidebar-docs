...
export interface MDX_extensions_plugins_extensions_plugins_jupyterlabProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupyterlab({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupyterlabProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jupyterlab.displayName = 'MDX_extensions_plugins_extensions_plugins_jupyterlab';
MDX_extensions_plugins_extensions_plugins_jupyterlab.frontmatter = frontmatter;
