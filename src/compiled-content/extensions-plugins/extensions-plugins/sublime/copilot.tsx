...
export interface MDX_extensions_plugins_extensions_plugins_sublime_copilotProps {
...
export default function MDX_extensions_plugins_extensions_plugins_sublime_copilot({ components = {} }: MDX_extensions_plugins_extensions_plugins_sublime_copilotProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_sublime_copilot.displayName = 'MDX_extensions_plugins_extensions_plugins_sublime_copilot';
MDX_extensions_plugins_extensions_plugins_sublime_copilot.frontmatter = frontmatter;
