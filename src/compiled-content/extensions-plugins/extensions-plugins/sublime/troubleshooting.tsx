...
export interface MDX_extensions_plugins_extensions_plugins_sublime_troubleshootingProps {
...
export default function MDX_extensions_plugins_extensions_plugins_sublime_troubleshooting({ components = {} }: MDX_extensions_plugins_extensions_plugins_sublime_troubleshootingProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_sublime_troubleshooting.displayName = 'MDX_extensions_plugins_extensions_plugins_sublime_troubleshooting';
MDX_extensions_plugins_extensions_plugins_sublime_troubleshooting.frontmatter = frontmatter;
