...
export interface MDX_extensions_plugins_extensions_plugins_sublime_drive_search_reuseProps {
...
export default function MDX_extensions_plugins_extensions_plugins_sublime_drive_search_reuse({ components = {} }: MDX_extensions_plugins_extensions_plugins_sublime_drive_search_reuseProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_sublime_drive_search_reuse.displayName = 'MDX_extensions_plugins_extensions_plugins_sublime_drive_search_reuse';
MDX_extensions_plugins_extensions_plugins_sublime_drive_search_reuse.frontmatter = frontmatter;
