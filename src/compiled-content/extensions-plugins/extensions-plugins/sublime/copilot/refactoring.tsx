...
export interface MDX_extensions_plugins_extensions_plugins_sublime_copilot_refactoringProps {
...
export default function MDX_extensions_plugins_extensions_plugins_sublime_copilot_refactoring({ components = {} }: MDX_extensions_plugins_extensions_plugins_sublime_copilot_refactoringProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_sublime_copilot_refactoring.displayName = 'MDX_extensions_plugins_extensions_plugins_sublime_copilot_refactoring';
MDX_extensions_plugins_extensions_plugins_sublime_copilot_refactoring.frontmatter = frontmatter;
