...
export interface MDX_extensions_plugins_extensions_plugins_sublime_commandsProps {
...
export default function MDX_extensions_plugins_extensions_plugins_sublime_commands({ components = {} }: MDX_extensions_plugins_extensions_plugins_sublime_commandsProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_sublime_commands.displayName = 'MDX_extensions_plugins_extensions_plugins_sublime_commands';
MDX_extensions_plugins_extensions_plugins_sublime_commands.frontmatter = frontmatter;
