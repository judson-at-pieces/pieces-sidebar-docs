...
export interface MDX_extensions_plugins_extensions_plugins_sublime_configurationProps {
...
export default function MDX_extensions_plugins_extensions_plugins_sublime_configuration({ components = {} }: MDX_extensions_plugins_extensions_plugins_sublime_configurationProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_sublime_configuration.displayName = 'MDX_extensions_plugins_extensions_plugins_sublime_configuration';
MDX_extensions_plugins_extensions_plugins_sublime_configuration.frontmatter = frontmatter;
