...
export interface MDX_extensions_plugins_extensions_plugins_sublime_driveProps {
...
export default function MDX_extensions_plugins_extensions_plugins_sublime_drive({ components = {} }: MDX_extensions_plugins_extensions_plugins_sublime_driveProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_sublime_drive.displayName = 'MDX_extensions_plugins_extensions_plugins_sublime_drive';
MDX_extensions_plugins_extensions_plugins_sublime_drive.frontmatter = frontmatter;
