...
export interface MDX_extensions_plugins_extensions_plugins_untitled_pageasdProps {
...
export default function MDX_extensions_plugins_extensions_plugins_untitled_pageasd({ components = {} }: MDX_extensions_plugins_extensions_plugins_untitled_pageasdProps) {
  const _components = {
