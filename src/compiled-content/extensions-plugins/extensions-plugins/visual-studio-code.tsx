...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_codeProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_code({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_codeProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_code.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_code';
MDX_extensions_plugins_extensions_plugins_visual_studio_code.frontmatter = frontmatter;
