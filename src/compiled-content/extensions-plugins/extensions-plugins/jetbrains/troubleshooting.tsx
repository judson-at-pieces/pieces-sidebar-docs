...
export interface MDX_extensions_plugins_extensions_plugins_jetbrains_troubleshootingProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jetbrains_troubleshooting({ components = {} }: MDX_extensions_plugins_extensions_plugins_jetbrains_troubleshootingProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jetbrains_troubleshooting.displayName = 'MDX_extensions_plugins_extensions_plugins_jetbrains_troubleshooting';
MDX_extensions_plugins_extensions_plugins_jetbrains_troubleshooting.frontmatter = frontmatter;
