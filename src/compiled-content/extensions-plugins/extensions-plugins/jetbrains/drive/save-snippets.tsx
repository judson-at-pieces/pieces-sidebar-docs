...
export interface MDX_extensions_plugins_extensions_plugins_jetbrains_drive_save_snippetsProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jetbrains_drive_save_snippets({ components = {} }: MDX_extensions_plugins_extensions_plugins_jetbrains_drive_save_snippetsProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jetbrains_drive_save_snippets.displayName = 'MDX_extensions_plugins_extensions_plugins_jetbrains_drive_save_snippets';
MDX_extensions_plugins_extensions_plugins_jetbrains_drive_save_snippets.frontmatter = frontmatter;
