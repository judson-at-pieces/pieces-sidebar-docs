...
export interface MDX_extensions_plugins_extensions_plugins_jetbrains_drive_sharingProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jetbrains_drive_sharing({ components = {} }: MDX_extensions_plugins_extensions_plugins_jetbrains_drive_sharingProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jetbrains_drive_sharing.displayName = 'MDX_extensions_plugins_extensions_plugins_jetbrains_drive_sharing';
MDX_extensions_plugins_extensions_plugins_jetbrains_drive_sharing.frontmatter = frontmatter;
