...
export interface MDX_extensions_plugins_extensions_plugins_jetbrains_driveProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jetbrains_drive({ components = {} }: MDX_extensions_plugins_extensions_plugins_jetbrains_driveProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jetbrains_drive.displayName = 'MDX_extensions_plugins_extensions_plugins_jetbrains_drive';
MDX_extensions_plugins_extensions_plugins_jetbrains_drive.frontmatter = frontmatter;
