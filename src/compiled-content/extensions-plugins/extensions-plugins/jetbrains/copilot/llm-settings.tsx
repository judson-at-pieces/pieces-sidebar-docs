...
export interface MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_llm_settingsProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_llm_settings({ components = {} }: MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_llm_settingsProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_llm_settings.displayName = 'MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_llm_settings';
MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_llm_settings.frontmatter = frontmatter;
