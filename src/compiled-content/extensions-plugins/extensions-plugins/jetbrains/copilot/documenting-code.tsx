...
export interface MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_documenting_codeProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_documenting_code({ components = {} }: MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_documenting_codeProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_documenting_code.displayName = 'MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_documenting_code';
MDX_extensions_plugins_extensions_plugins_jetbrains_copilot_documenting_code.frontmatter = frontmatter;
