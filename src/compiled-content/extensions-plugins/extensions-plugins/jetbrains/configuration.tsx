...
export interface MDX_extensions_plugins_extensions_plugins_jetbrains_configurationProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jetbrains_configuration({ components = {} }: MDX_extensions_plugins_extensions_plugins_jetbrains_configurationProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jetbrains_configuration.displayName = 'MDX_extensions_plugins_extensions_plugins_jetbrains_configuration';
MDX_extensions_plugins_extensions_plugins_jetbrains_configuration.frontmatter = frontmatter;
