...
export interface MDX_extensions_plugins_extensions_plugins_jetbrains_copilotProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jetbrains_copilot({ components = {} }: MDX_extensions_plugins_extensions_plugins_jetbrains_copilotProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jetbrains_copilot.displayName = 'MDX_extensions_plugins_extensions_plugins_jetbrains_copilot';
MDX_extensions_plugins_extensions_plugins_jetbrains_copilot.frontmatter = frontmatter;
