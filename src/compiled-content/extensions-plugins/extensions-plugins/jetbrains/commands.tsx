...
export interface MDX_extensions_plugins_extensions_plugins_jetbrains_commandsProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jetbrains_commands({ components = {} }: MDX_extensions_plugins_extensions_plugins_jetbrains_commandsProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jetbrains_commands.displayName = 'MDX_extensions_plugins_extensions_plugins_jetbrains_commands';
MDX_extensions_plugins_extensions_plugins_jetbrains_commands.frontmatter = frontmatter;
