...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_troubleshootingProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_troubleshooting({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_troubleshootingProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_troubleshooting.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_troubleshooting';
MDX_extensions_plugins_extensions_plugins_visual_studio_troubleshooting.frontmatter = frontmatter;
