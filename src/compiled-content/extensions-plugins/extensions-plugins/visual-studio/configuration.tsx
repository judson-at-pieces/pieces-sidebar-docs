...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_configurationProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_configuration({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_configurationProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_configuration.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_configuration';
MDX_extensions_plugins_extensions_plugins_visual_studio_configuration.frontmatter = frontmatter;
