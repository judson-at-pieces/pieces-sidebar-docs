...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_commandsProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_commands({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_commandsProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_commands.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_commands';
MDX_extensions_plugins_extensions_plugins_visual_studio_commands.frontmatter = frontmatter;
