...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_driveProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_drive({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_driveProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_drive.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_drive';
MDX_extensions_plugins_extensions_plugins_visual_studio_drive.frontmatter = frontmatter;
