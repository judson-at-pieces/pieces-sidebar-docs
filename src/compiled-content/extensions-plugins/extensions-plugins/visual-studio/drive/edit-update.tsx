...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_drive_edit_updateProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_drive_edit_update({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_drive_edit_updateProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_drive_edit_update.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_drive_edit_update';
MDX_extensions_plugins_extensions_plugins_visual_studio_drive_edit_update.frontmatter = frontmatter;
