...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_get_startedProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_get_started({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_get_startedProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_get_started.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_get_started';
MDX_extensions_plugins_extensions_plugins_visual_studio_get_started.frontmatter = frontmatter;
