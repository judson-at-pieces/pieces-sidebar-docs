...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_copilot_refactoringProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_copilot_refactoring({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_copilot_refactoringProps) {
  const _components = {
