...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_copilotProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_copilot({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_copilotProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_copilot.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_copilot';
MDX_extensions_plugins_extensions_plugins_visual_studio_copilot.frontmatter = frontmatter;
