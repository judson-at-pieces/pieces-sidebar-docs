...
export interface MDX_extensions_plugins_extensions_plugins_visual_studioProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studioProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio';
MDX_extensions_plugins_extensions_plugins_visual_studio.frontmatter = frontmatter;
