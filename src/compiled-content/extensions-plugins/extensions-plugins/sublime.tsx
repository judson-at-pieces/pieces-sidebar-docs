...
export interface MDX_extensions_plugins_extensions_plugins_sublimeProps {
...
export default function MDX_extensions_plugins_extensions_plugins_sublime({ components = {} }: MDX_extensions_plugins_extensions_plugins_sublimeProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_sublime.displayName = 'MDX_extensions_plugins_extensions_plugins_sublime';
MDX_extensions_plugins_extensions_plugins_sublime.frontmatter = frontmatter;
