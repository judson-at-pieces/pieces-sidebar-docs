...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_code_forksProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_code_forks({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_code_forksProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_code_forks.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_code_forks';
MDX_extensions_plugins_extensions_plugins_visual_studio_code_forks.frontmatter = frontmatter;
