...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_code_driveProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_code_drive({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_code_driveProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_code_drive.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_code_drive';
MDX_extensions_plugins_extensions_plugins_visual_studio_code_drive.frontmatter = frontmatter;
