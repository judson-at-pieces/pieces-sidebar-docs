...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_code_commandsProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_code_commands({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_code_commandsProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_code_commands.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_code_commands';
MDX_extensions_plugins_extensions_plugins_visual_studio_code_commands.frontmatter = frontmatter;
