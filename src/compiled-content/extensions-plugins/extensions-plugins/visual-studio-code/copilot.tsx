...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_code_copilotProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_code_copilot({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_code_copilotProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_code_copilot.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_code_copilot';
MDX_extensions_plugins_extensions_plugins_visual_studio_code_copilot.frontmatter = frontmatter;
