...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_code_troubleshootingProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_code_troubleshooting({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_code_troubleshootingProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_code_troubleshooting.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_code_troubleshooting';
MDX_extensions_plugins_extensions_plugins_visual_studio_code_troubleshooting.frontmatter = frontmatter;
