...
export interface MDX_extensions_plugins_extensions_plugins_visual_studio_code_configurationProps {
...
export default function MDX_extensions_plugins_extensions_plugins_visual_studio_code_configuration({ components = {} }: MDX_extensions_plugins_extensions_plugins_visual_studio_code_configurationProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_visual_studio_code_configuration.displayName = 'MDX_extensions_plugins_extensions_plugins_visual_studio_code_configuration';
MDX_extensions_plugins_extensions_plugins_visual_studio_code_configuration.frontmatter = frontmatter;
