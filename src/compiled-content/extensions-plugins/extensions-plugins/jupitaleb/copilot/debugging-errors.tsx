...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_debugging_errorsProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_debugging_errors({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_debugging_errorsProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_debugging_errors.displayName = 'MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_debugging_errors';
MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_debugging_errors.frontmatter = frontmatter;
