...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_documenting_codeProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_documenting_code({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_documenting_codeProps) {
  const _components = {
