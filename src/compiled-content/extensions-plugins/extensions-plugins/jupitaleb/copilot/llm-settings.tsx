...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_llm_settingsProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_llm_settings({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_llm_settingsProps) {
  const _components = {
