...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_chatProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_chat({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot_chatProps) {
  const _components = {
