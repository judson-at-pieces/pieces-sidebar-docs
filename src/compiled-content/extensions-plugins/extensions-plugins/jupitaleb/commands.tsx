...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_commandsProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_commands({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_commandsProps) {
  const _components = {
