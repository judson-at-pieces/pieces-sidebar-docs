...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_driveProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_drive({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_driveProps) {
  const _components = {
