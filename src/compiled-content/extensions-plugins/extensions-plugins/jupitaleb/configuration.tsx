...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_configurationProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_configuration({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_configurationProps) {
  const _components = {
