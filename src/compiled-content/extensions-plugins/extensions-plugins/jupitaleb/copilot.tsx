...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_copilotProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_copilot({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_copilotProps) {
  const _components = {
