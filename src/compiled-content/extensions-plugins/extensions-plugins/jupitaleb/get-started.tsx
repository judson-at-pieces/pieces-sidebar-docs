...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_get_startedProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_get_started({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_get_startedProps) {
  const _components = {
