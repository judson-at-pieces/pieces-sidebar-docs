...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_saveProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_save({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_saveProps) {
  const _components = {
