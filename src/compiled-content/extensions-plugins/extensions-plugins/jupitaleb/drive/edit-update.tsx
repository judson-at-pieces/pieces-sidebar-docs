...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_edit_updateProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_edit_update({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_edit_updateProps) {
  const _components = {
