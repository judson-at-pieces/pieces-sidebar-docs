...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_shareProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_share({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_shareProps) {
  const _components = {
