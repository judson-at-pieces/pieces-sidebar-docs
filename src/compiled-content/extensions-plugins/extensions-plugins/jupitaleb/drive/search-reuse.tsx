...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_search_reuseProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_search_reuse({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_drive_search_reuseProps) {
  const _components = {
