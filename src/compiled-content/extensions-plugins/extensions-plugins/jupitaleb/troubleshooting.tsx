...
export interface MDX_extensions_plugins_extensions_plugins_jupitaleb_troubleshootingProps {
...
export default function MDX_extensions_plugins_extensions_plugins_jupitaleb_troubleshooting({ components = {} }: MDX_extensions_plugins_extensions_plugins_jupitaleb_troubleshootingProps) {
  const _components = {
...
MDX_extensions_plugins_extensions_plugins_jupitaleb_troubleshooting.displayName = 'MDX_extensions_plugins_extensions_plugins_jupitaleb_troubleshooting';
MDX_extensions_plugins_extensions_plugins_jupitaleb_troubleshooting.frontmatter = frontmatter;
