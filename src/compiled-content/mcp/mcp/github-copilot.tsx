...
export interface MDX_mcp_mcp_github_copilotProps {
...
export default function MDX_mcp_mcp_github_copilot({ components = {} }: MDX_mcp_mcp_github_copilotProps) {
  const _components = {
...
MDX_mcp_mcp_github_copilot.displayName = 'MDX_mcp_mcp_github_copilot';
MDX_mcp_mcp_github_copilot.frontmatter = frontmatter;
