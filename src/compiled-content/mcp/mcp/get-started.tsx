...
export interface MDX_mcp_mcp_get_startedProps {
...
export default function MDX_mcp_mcp_get_started({ components = {} }: MDX_mcp_mcp_get_startedProps) {
  const _components = {
...
MDX_mcp_mcp_get_started.displayName = 'MDX_mcp_mcp_get_started';
MDX_mcp_mcp_get_started.frontmatter = frontmatter;
