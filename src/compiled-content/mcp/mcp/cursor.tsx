...
export interface MDX_mcp_mcp_cursorProps {
...
export default function MDX_mcp_mcp_cursor({ components = {} }: MDX_mcp_mcp_cursorProps) {
  const _components = {
...
MDX_mcp_mcp_cursor.displayName = 'MDX_mcp_mcp_cursor';
MDX_mcp_mcp_cursor.frontmatter = frontmatter;
