...
export interface MDX_mcp_mcp_gooseProps {
...
export default function MDX_mcp_mcp_goose({ components = {} }: MDX_mcp_mcp_gooseProps) {
  const _components = {
...
MDX_mcp_mcp_goose.displayName = 'MDX_mcp_mcp_goose';
MDX_mcp_mcp_goose.frontmatter = frontmatter;
