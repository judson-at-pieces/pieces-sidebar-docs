...
export interface MDX_mcp_mcp_promptingProps {
...
export default function MDX_mcp_mcp_prompting({ components = {} }: MDX_mcp_mcp_promptingProps) {
  const _components = {
...
MDX_mcp_mcp_prompting.displayName = 'MDX_mcp_mcp_prompting';
MDX_mcp_mcp_prompting.frontmatter = frontmatter;
