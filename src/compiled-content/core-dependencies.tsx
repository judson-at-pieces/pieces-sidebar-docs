...
export interface MDX_core_dependenciesProps {
...
export default function MDX_core_dependencies({ components = {} }: MDX_core_dependenciesProps) {
  const _components = {
...
MDX_core_dependencies.displayName = 'MDX_core_dependencies';
MDX_core_dependencies.frontmatter = frontmatter;
