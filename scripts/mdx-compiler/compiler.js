...
\`;
  ...
  console.log('${componentName}: Rendering with HashnodeMarkdownRenderer');
  console.log('${componentName}: Content length:', fullContent.length);
  
  return <HashnodeMarkdownRenderer content={fullContent} />;
}
