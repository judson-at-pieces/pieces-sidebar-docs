...
DROP CONSTRAINT IF EXISTS live_editing_sessions_file_path_key;
...
-- Create new unique constraint that includes branch_name for uniqueness per branch
ALTER TABLE public.live_editing_sessions 
ADD CONSTRAINT live_editing_sessions_branch_file_unique 
UNIQUE (file_path, branch_name);
