...
-- Update the get_navigation_structure function to filter out PRIVATE items
...
AS $function$
  WITH sections_with_items AS (
    ...
    LEFT JOIN public.navigation_items i ON s.id = i.section_id 
      AND i.is_active = true 
      AND (i.privacy = 'PUBLIC' OR i.privacy IS NULL)  -- Only include PUBLIC items
